...
public class Cfw100 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fileBornes.exists()){
            bornes.setImageResource(R.drawable.cfw100guia);
        }
        if (fileManual.exists()){
            manual.setImageResource(R.drawable.cfw100);
        }

        manual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "cfw100.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1RY3ChhuQ_W4b2qaKtGoCj2A3H0twVcPs&export=download";
        ...
        bornes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "cfw100guia.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1Bfha-f_Sz6oyLRHhEMe8RYUeizd-3NgE&export=download";
                File file = new File(getExternalFilesDir(null), nomeArquivo);
