...
public class Mvw3000 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fileBornes.exists()){
            borne.setImageResource(R.drawable.mvw500guia);
        }
        if (fileManual.exists()){
            manual.setImageResource(R.drawable.mvw3000);
        }
        ...
        manual.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                nomeArquivo = "mvw3000.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1j_CgCmtEsy0e0L6fW4Pw0b-joO2BX729&export=download";
        ...
        borne.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "mvw3000guia.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1ysCj2vctrtYQwsgWP3nMRPNAEyFcTGfo&export=download";
                File file = new File(getExternalFilesDir(null), nomeArquivo);
