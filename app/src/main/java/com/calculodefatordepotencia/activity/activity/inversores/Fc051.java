...
public class Fc051 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fileFc51B.exists()){
            bornes.setImageResource(R.drawable.fc051);
        }
        if (fileFc51M.exists()){
            manual.setImageResource(R.drawable.fc051);
        }

        bornes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "fc051_regua_de_bornes.pdf";
                String url = "https://"+
                "drive.google.com/u/0/uc?id=1ngKezX9xpL0iCtuxsoj12HUzloEt7cvi&export=download";
        ...
        manual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "fc051.pdf";
                String url = "https://"+
                "drive.google.com/u/0/uc?id=1SmBrFKimkVdKzW67QmvcY36ZGrg0rgqh&export=download";
                File file = new File(getExternalFilesDir(null), nomeArquivo);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (downloadId==id){
                ...
                if (DownloadManager.STATUS_SUCCESSFUL == status) {
                    ...
                    dialog.dismiss();
                    switch (nomeArquivo){
                        case "fc051_regua_de_bornes.pdf":
                            bornes.setImageResource(R.drawable.fc051);
                            break;
                        case "fc051.pdf":
                            manual.setImageResource(R.drawable.fc051);
