...
public class InversoresDanfos extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fileFc101.exists()){
            fc101.setImageResource(R.drawable.fc101m);
        }
        if (fileFc202.exists()){
            fc202.setImageResource(R.drawable.fc202);
        }
        ...
        fc101.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "fc101.pdf";
                String url = "https://"+
                "drive.google.com/u/0/uc?id=1Sq2o1JSpDqDNfLneaIe5DTsMqHDKJoT6&export=download";
        ...
        fc202.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "fc202.pdf";
                String url = "https://"+
                "drive.google.com/u/0/uc?id=138gBh8GL3gE8NNnRSIcMpJRbUj8EUinI&export=download";
                File file = new File(getExternalFilesDir(null), nomeArquivo);
