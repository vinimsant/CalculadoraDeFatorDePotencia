...
public class Cfw300 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        File fileBornes = new File(getExternalFilesDir(null), "guiaCfw300.pdf");
        File fileManual = new File(getExternalFilesDir(null), "manualCfw300.pdf");
        if (fileBornes.exists()){
            bornes.setImageResource(R.drawable.cfw300guia);
        }
        if (fileManual.exists()){
            manual.setImageResource(R.drawable.cfw300);
        }

        manual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "manualCfw300.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1ajjH1uXOz-mazOTA_Zm4BnYt2m068HbC&export=download";
        ...
        bornes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "guiaCfw300.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1Ry4tdfcrtctGVhXkJGvkc3SvOVWpzsye&export=download";
                File file = new File(getExternalFilesDir(null), nomeArquivo);
