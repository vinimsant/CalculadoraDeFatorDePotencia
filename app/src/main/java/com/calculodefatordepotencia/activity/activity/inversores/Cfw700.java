...
public class Cfw700 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fileBornes.exists()){
            bornes.setImageResource(R.drawable.cfw700guia);
        }
        if (fileManual.exists()){
            manual.setImageResource(R.drawable.cfw700);
        }

        manual.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "cfw700.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1QcFvN2jAL9JZQQqK-1ELucxxqxOar83o&export=download";
        ...
        bornes.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "cfw700guia.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1t69p2GiIY3Mk7RAqp0NUDXbXubkNo7YX&export=download";
                File file = new File(getExternalFilesDir(null), nomeArquivo);
