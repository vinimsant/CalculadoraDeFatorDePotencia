...
public class Cfw500 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (fileBornes.exists()){
            imgCfw500Guia.setImageResource(R.drawable.cfw500g);
        }
        if (fileManual.exists()){
            imgCfw500Manuais.setImageResource(R.drawable.cfw500);
        }

        imgCfw500Manuais.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "WEG-cfw500-manual-de-programacao-10001469555-1.1x-manual-portugues-br.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1l8krp2n4zflnrrg0mG5WrCERFoQoYUpw&export=download";
        ...
        imgCfw500Guia.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                nomeArquivo = "Manual-do-Usuário-CFW500-regua de borne.pdf";
                String url = "https://"+
                        "drive.google.com/u/0/uc?id=1cTaNljG-qMkSAN0rE2i0TcLOtFOVnqi7&export=download";
                File file = new File(getExternalFilesDir(null), nomeArquivo);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (downloadId==id){
                ...
                if (DownloadManager.STATUS_SUCCESSFUL == status) {
                    ...
                    dialog.dismiss();
                    switch (nomeArquivo){
                        case "Manual-do-Usuário-CFW500-regua de borne.pdf":
                            imgCfw500Guia.setImageResource(R.drawable.cfw500g);
                            break;
                        case "WEG-cfw500-manual-de-programacao-10001469555-1.1x-manual-portugues-br.pdf":
                            imgCfw500Manuais.setImageResource(R.drawable.cfw500);
                            break;
                    }
                }
